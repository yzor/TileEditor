...
var colors = {
    ...
    d: "green",
    l: "white",
    qwe1: "rgba(225, 225, 225, 0.3)",
    qwe2: "#ff9800", //оранжевый
    qwe3: "rgba(31, 31, 31, 0.94)",
    qwe4: "rgba(26, 25, 25, 1)",
    qwe5: "",
    qwe6: "",
    qwe7: "",
}
...
function nextColor() {
    ...
    var color = materialOrder.shift()//получили цвет
    materialOrder.push(color);//добавили его в конец  #TODO изменить
    var color2 = material[color][materialforce]
    if (TE.selected) TE.selected.color = color2;//#запись в головной объект
    console.log(
        "%c " + color2 + " %c " + color+" ",
        "color:black;background:" + color2 + ";",
        "color:black;background:" + material[color][500] + ";");
}
...
var materialforce = "500";
// var materialforce = "a400";
var materialOrder = [
    "yellow",
    "lightblue",
    "red",
...
var material = {
    //https://gist.github.com/amitzur/6ef49f01a662bae992a4
